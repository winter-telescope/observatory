...
class ObsLogger(object):
    ...
    def __init__(self, log_name, survey_start_time = Time('2018-01-01'),
        ...
        #for now hardcode the location of the history database
        self.historyEngine = create_engine(
                'sqlite:///'+os.path.join(BASE_DIR,f'demoRelational.db'))
        self.history = pd.read_sql('Summary', self.historyEngine)
