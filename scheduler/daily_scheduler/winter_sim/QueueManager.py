...
class QueueEmptyError(Exception):
    """Error class for when the nightly queue has no fields"""
    pass
...
#            time_limit = time_limit)
    ...
    def _sequence_requests_in_block(self, current_state, time_limit = 300.*u.second):
            ...
            for i in test_list:
                ...
                for j in test_list:
                    ...
                    if i == j:
                        ...
                        #check if changing cameras between summer and winter
                        if ((i in WINTER_FILTERS) and (j in WINTER_FILTERS)) or ((i in SUMMER_FILTERS) and (j in SUMMER_FILTERS)):
       ...
       # print("do slews")
        ...
        # TODO check camera and change readout time 
