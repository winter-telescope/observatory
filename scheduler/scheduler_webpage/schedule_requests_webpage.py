...
if env == "PRODUCTION":
    too_path = 'sqlite:////home/winter/data/schedules/ToO/HighPriority/'
    req_path = '/home/winter/data/schedules/requests/'
    config_path ='../../wsp/config/scheduleconfig.json'
    write_path = '/home/winter/data/schedules/requests/'
    wsp_path = '../../wsp'
...
def web_form():  
    ...
    if type_obs['timing'] == 'Time sensitive':
        ...
        ret = make_untimed_request(write_path, type_obs['camera'], time_insensitive, field_opts, filters)
