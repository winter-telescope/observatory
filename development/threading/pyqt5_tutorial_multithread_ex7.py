...
This example is based on the ThreadIO section. It defines a signal QObject
which holds custom signals to communicate between the worker threads
and the GUI thread
...
class MainWindow(QtWidgets.QMainWindow):
    ...
    def oh_no(self):
        ...
        worker = Worker(self.returnWord,'Fartz')
