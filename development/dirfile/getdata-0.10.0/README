...
# NPL 4/29/20: To install on mac, had to install libtool. Did this by installing brew (from brew.sh)
  and then doing "brew install libtool".   THen it seems to have worked.
# also did "brew install automake" bc the thing wouldn't run the install properly
# also had a problem with: fatal error: 'php.h' file not found

# followed the instructions from here: https://stackoverflow.com/questions/52623108/installing-xdebug-on-macos-mojave-php-h-file-not-found
# and did this:
# >> xcode-select --install
# >> sudo installer -pkg /Library/Developer/CommandLineTools/Packages/macOS_SDK_headers_for_macOS_10.14.pkg -target /
# still had some php error when running on the flash drive. copied the .gz zip to my downloads folder and trying again.
