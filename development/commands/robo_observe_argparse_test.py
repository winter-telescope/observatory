...
argv = 'robo_observe altaz 45 245 '
...
flat_alt = 75
flat_az = 270
ra_total_offset_arcmin = 10
dec_total_offset_arcmin = 0
qcomment = f"Auto Flats {i+1}/{nflats} Alt/Az = ({flat_alt}, {flat_az}), RA +{ra_total_offset_arcmin}', DEC +{dec_total_offset_arcmin}' "
