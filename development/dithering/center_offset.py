...
def get_center_offset_coords(
    ...
    base_pointing_x_pixel = config['observing_parameters'][camname]['base_position']['x_pixel']
    base_pointing_y_pixel = config['observing_parameters'][camname]['base_position']['y_pixel']
    ...
    if camname == 'winter':
        ...
        base_pointing_board = config['observing_parameters'][camname]['base_position']['board_id']
...
def is_rotator_mech_angle_possible(predicted_rotator_mechangle, rotator_min_degs,
                                   rotator_max_degs):
    return (predicted_rotator_mechangle > rotator_min_degs) and (
            predicted_rotator_mechangle < rotator_max_degs)

def get_safe_rotator_angle(ra_hours, dec_deg, target_field_angle, obstime = None, verbose = False):
    """
    ...
    possible_target_mech_angles = [(target_field_angle - parallactic_angle -target_alt) 
