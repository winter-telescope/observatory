...
class palomarWeather(object):
    ...
    def getFakeWeather(self):
        # this should go into getWeather, with DateTime toggling the value every 10 minutes
    ...
    def getWeather(self,firsttime = False):
        ...
        # Commented because these have been moved to the pyro get weather function.
